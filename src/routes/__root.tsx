...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Variaciones de video ads con OpenRouter + Claude/Gemini + Higgsfield" },
      { name: "author", content: "Ad Factory Studio" },
      { property: "og:title", content: "Ad Factory Studio" },
      { property: "og:description", content: "Variaciones de video ads con OpenRouter + Claude/Gemini + Higgsfield" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Ad Factory Studio" },
      { name: "twitter:description", content: "Variaciones de video ads con OpenRouter + Claude/Gemini + Higgsfield" },
