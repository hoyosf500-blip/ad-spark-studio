      ...
      <main className="mx-auto max-w-4xl px-4 py-24">
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base text-muted-foreground">
            Sube un video ganador, Claude analiza frame-por-frame y genera 6 variaciones listas para
            anunciar. Imagen + animación inline, sin copiar prompts a otras tools.
          </p>
        ...
        <div className="mt-20 grid grid-cols-1 gap-4 md:grid-cols-3">
          {[
            { icon: Sparkles, t: "Claude analiza", d: "Frame-por-frame, 6 variaciones con guión + image prompts + animation prompts." },
            { icon: Layers, t: "Qwen renderiza texto", d: "Qwen-Image-Max es el mejor renderizando español legible para anuncios COD." },
            { icon: Video, t: "Wan 2.6 anima", d: "Image-to-video 9:16, cola paralela con reanudación entre sesiones." },
          ].map((f) => (
